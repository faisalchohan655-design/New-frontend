...
const CampaignOutreach = () => {
  console.log('🔥 CampaignOutreach component rendering');
  ...
  try {
    ...
    useEffect(() => {
      ...
      api.get('/leads')
        .then(res => { 
          ...
          setLoading(false); 
          console.log('✅ Leads loaded:', res.data.length);
        })
        .catch(err => { 
    ...
    console.error('💥 CampaignOutreach render error:', err);
    return <div className="p-6 text-center text-red-500">Something went wrong. Please check console.</div>;
  }
};
